 ...
 * @author Amanda
 */
public class Hash2GradeBook implements GradeBooking {

    Map<Student2, Grade> map = new HashMap<>();
    ...
    public void csvImport(String filename) {
        try {
            ...
            while (in.hasNext()) {
                ...
                Student2 s = new Student2(firstName, lastName, pID);
    ...
    /**
     * Iterates through the map looking for a specific key s of type Student2
